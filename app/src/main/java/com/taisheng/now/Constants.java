...
//        public static String File_Host = "http://49.234.71.11:8888/";
       ...
       /* public static String Host = "http://192.168.1.18:8080/";//有视频的
        ...
        public static class Watch {
            ...
            //            APP-获取血压的实时数据
            public static final String getbloodpressure = "jeecg-boot/app/watchblood/getbloodpressure";
            //            APP-获取心率的实时数据
            public static final String getheartrate = "jeecg-boot/app/heartrate/getheartrate";
            //            APP-获取计步的实时数据
            public static final String getwatchstep = "jeecg-boot/app/step/getwatchstep";
