...
public class SpanStringUtils {
    ...
    public static SpannableString getEmotionContent(int emotion_map_type, final Context context, final TextView tv, String source) {
        ...
        String regexEmotion = "face\\[([\u4e00-\u9fa5\\w])+\\]";
...
//				ImageSpan span = new ImageSpan(context, scaleBitmap);
    ...
    public static SpannableString megetEmotionContent(int emotion_map_type, final Context context, String source) {
        SpannableString spannableString = new SpannableString(source);
        Resources res = context.getResources();
