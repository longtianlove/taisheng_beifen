 ...
 */
public class Watch_EmotionKeyboard {

    private static final String SHARE_PREFERENCE_NAME = "EmotionKeyboard";
    private static final String SHARE_PREFERENCE_SOFT_INPUT_HEIGHT = "soft_input_height";
    private static final String TAG = Watch_EmotionKeyboard.class.getSimpleName();
     ...
     * @return
     */
    public static Watch_EmotionKeyboard with(Activity activity) {
        Watch_EmotionKeyboard emotionInputDetector = new Watch_EmotionKeyboard();
     ...
     * @return
     */
    public Watch_EmotionKeyboard bindToContent(View contentView) {
     ...
     * @return
     */
    public Watch_EmotionKeyboard bindToEditText(EditText editText) {
        mEditText = editText;
     ...
     * @return
     */
    public Watch_EmotionKeyboard setEmotionView(View emotionView) {
        mEmotionLayout = emotionView;
        return this;
    }

    public Watch_EmotionKeyboard build() {
