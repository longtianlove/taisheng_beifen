...
public class HistoryGuijiMapInstance extends BDAbstractLocationListener {


    public static HistoryGuijiMapInstance instance;

    private HistoryGuijiMapInstance() {

    }


    public static HistoryGuijiMapInstance getInstance() {
        if (instance == null) {
            synchronized (HistoryGuijiMapInstance.class) {
                if (instance == null) {
                    instance = new HistoryGuijiMapInstance();
                }
            }
        }
        return instance;
