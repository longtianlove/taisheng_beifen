...
public class MyKajuanActivity extends BaseIvActivity {
    @BindView(R.id.tl_tab)
    TabLayout tlTab;
    @BindView(R.id.vp_content)
    ViewPager vpContent;
    private KanjuanFragment daishiyongFragment;
    private KanjuanFragment yishiyongFragment;
    private KanjuanFragment yiguoqiFragmnt;
    ...
    public void setChangeTitle(TextView tvLeft, TextView tvTitle, TextView tvRight, ImageView ivRight, ImageView ivTitle) {
        tvTitle.setText(getString(R.string.my_card));
    }
