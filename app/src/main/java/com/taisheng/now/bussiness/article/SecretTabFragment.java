...
public class SecretTabFragment extends BaseFragment {
    ...
    public void initData_first() {
        DOCTOR_pageNo = 1;
        getDoctorTypeList_first();
        PAGE_NO = 1;
        PAGE_SIZE = 10;
        if (data != null) {
            data.clear();
    ...
    void getDoctorTypeList_first() {
        ...
        ApiUtils.getApiService_hasdialog().getDoctorTypeList(bean).enqueue(new TaiShengCallback<BaseBean<DoctorsResultBean>>() {
            @Override
